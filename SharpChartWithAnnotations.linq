...
public class SharpPlot {
	...
	public SharpPlot(int[] xs, List<Tuple<string,double[]>> ys, int width= 900, int height= 300)
	{
		...
		AddVerticalBreakAnnotation(10000,1,"LY2");
		AddVerticalBreakAnnotation(11000,1.5, "LY");
		AddVerticalBreakAnnotation(10000,2,"TY");


		
	}
	
	public void AddVerticalBreakAnnotation(double XAnchor, double YAnchor, string text)
	{
           ...
           //LineAnnotation annotation = new LineAnnotation();
			...
			rectangleAnnotation.Y = YAnchor;
			rectangleAnnotation.X = XAnchor;
